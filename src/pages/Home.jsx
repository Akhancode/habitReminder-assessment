...
const Home = () => {
  ...
  return (
    (habitsUpcomingData.length || habitsDoneData.length) ?
      <div className='flex flex-col  flex-grow text-black   w-full sm:px-12 md:px-24 md:flex-row md:flex-wrap  md:justify-start md:items-start'>

        <DateNav viewType={viewType} setViewType={setViewType} />
        <CategoryLabel/>
        {viewType == "today" && <div className='h-full w-full  '>
          ...
          <div className='w-full bg-white mt-5 py-2 h-fit  border-gray-100 border-b-[1px] flex font-sans  px-6 text-2xl text-gray-500 '>
            <p className={`cursor-pointer  select-none transition-colors duration-500  `}>Completed</p>
          </div>

          {/* completed */}
          <div className='flex px-5 mb-8 mt-3   flex-col gap-2 md:flex-row md:flex-wrap '>
        ...
        {/* <div className=' w-full h-full  flex flex-wrap md:justify-start md:items-start '> */}
        <div className='w-full h-full flex items-start'>

          <div className=' w-full   flex flex-wrap md:justify-start md:items-start self-start '>
